...
/////////LordOly//LordOly//LordOly//LordOly//
client.on("message", async msg => {
  ...
  let a = await db.fetch(`kufur_${msg.guild.id}`)
    if (a == 'acik') {
      const küfür = [
        "yarak","mk", "amk", "aq", "orospu", "oruspu", "oç", "sikerim", "yarrak", "piç", "amq", "sik", "amcık", "çocu", "sex", "seks", "amına", "orospu çocuğu", "sg", "siktir git","31","oc"
                  ]
...
//Lord Oly//LordOly//LordOly//LordOly//LordOly//LordOly//LordOly//LordOly//LordOly//LordOly//
...
.addField("Sunucudaki Kişi Sayısı:", guild.memberCount)
   ...
   client.channels.get('760822171328577566').send(rrrsembed);
...
.addField("Sunucudaki Kişi Sayısı:", guild.memberCount)
   ...
   client.channels.get('760822168107352074').send(rrrsembed);
